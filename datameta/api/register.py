...
def post(request):
    ...
    if org_create:
        log.info(f"Registration request, new group; req_email={req_email},name={name},org_new_name={org_new_name}")
    else:
        log.info(f"Registration request; req_email={req_email},name={name},group_name={group.name}")
