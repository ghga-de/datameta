...
def convert_samplesheet(db, file_like_obj, filename, user):
    ...
    try:
        ...
        log.info("Submitted sample sheet triggered exception", extra={"file_name": filename, "exception": e})
...
def post(request: Request) -> HTTPOk:
    ...
    try:
        ...
        log.warning("Unable to read sample sheet.", extra={"file_name": input_file.filename, "exception": e})
