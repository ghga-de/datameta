...
def upgrade():
    ...
    op.create_table(
        'msetreplacementevents',
        sa.Column('id', sa.Integer(), nullable=False),
        sa.Column('uuid', postgresql.UUID(as_uuid=True), nullable=False),
        sa.Column('user_id', sa.Integer(), nullable=False),
        sa.Column('datetime', sa.DateTime(), nullable=False),
        sa.Column('new_metadataset_id', sa.Integer(), nullable=False),
        sa.ForeignKeyConstraint(['new_metadataset_id'], ['metadatasets.id'], name=op.f('fk_msetreplacementevents_new_metadataset_id_metadatasets')),
        sa.ForeignKeyConstraint(['user_id'], ['users.id'], name=op.f('fk_msetreplacementevents_user_id_users')),
        sa.PrimaryKeyConstraint('id', name=op.f('pk_msetreplacementevents')),
        sa.UniqueConstraint('uuid', name=op.f('uq_msetreplacementevents_uuid'))
    )
    ...
    op.create_foreign_key(op.f('fk_metadatasets_replaced_via_event_id_msetreplacementevents'), 'metadatasets', 'msetreplacementevents', ['replaced_via_event_id'], ['id'], use_alter=True)
...
def downgrade():
    ...
    op.drop_constraint(op.f('fk_metadatasets_replaced_via_event_id_msetreplacementevents'), 'metadatasets', type_='foreignkey')
    ...
    op.drop_table('msetreplacementevents')
    # ### end Alembic commands ###
